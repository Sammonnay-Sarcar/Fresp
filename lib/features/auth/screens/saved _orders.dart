...
import 'package:fresp/features/auth/widgets/orders_widget.dart';
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: TextWidget(text:'Saved Orders',color: color,isTitle: true,
        textSize: 22,),
        ),
      ),
     body: Column(
    ...
    return SizedBox(
            ...
            child:Padding(
              ...
              child: Row(children: [
                FittedBox( child:TextWidget(text: 'Order History', color: Colors.black, textSize: 20,isTitle: true,
                ),),
              ],
              ),
            ),
